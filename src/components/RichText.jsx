...
const RichText = ({ content }) => {
  const Article = ({ children }) => <article className="article">{ children }</article>
  const Paragraph = ({ children }) => <p className="article-paragraph">{ children }</p>
  const Heading1 = ({ children }) => <h1 className="article-heading-1">{ children }</h1>
  const Heading2 = ({ children }) => <h2 className="article-heading-2">{ children }</h2>
  const Heading3 = ({ children }) => <h3 className="article-heading-3">{ children }</h3>
  const Heading4 = ({ children }) => <h4 className="article-heading-4">{ children }</h4>
  const Heading5 = ({ children }) => <h5 className="article-heading-5">{ children }</h5>
  const Heading6 = ({ children }) => <h6 className="article-heading-6">{ children }</h6>
  const List = ({ children }) => <ul className="article-ul">{ children }</ul>
  const OrderedList = ({ children }) => <ol className="article-ol">{ children }</ol>
  const ListItem = ({ children }) => <li className="article-list-item">{ children }</li>
  const BlockQuote = ({ children }) => <blockquote className="article-blockquote">{ children }</blockquote>
  ...
  const Underline = ({ children }) => <u className="article-underline">{ children }</u>
  const Code = ({ children }) => <code className="article-code">{ children }</code>
  ...
  return documentToReactComponents(content.childContentfulArticleBodyRichTextNode.json, richTextOptions)
}
